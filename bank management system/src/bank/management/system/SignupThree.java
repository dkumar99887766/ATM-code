...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        l1.setBounds(230, 10, 400, 40);
        add(l1);

        JLabel types = new JLabel("Account Type:");
        types.setFont(new Font("Raleway", Font.BOLD, 22));
        types.setBackground(Color.WHITE);
        types.setBounds(100, 100, 200, 30);
        add(types);
        ...
        carddetail.setBounds(100, 260, 250, 20);
        add(carddetail);
        ...
        pindetail.setBounds(100, 330, 250, 20);
        add(pindetail);
        ...
        submit.setBounds(140, 600, 100, 30);
